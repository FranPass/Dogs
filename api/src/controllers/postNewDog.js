...
const postNewDog = async (req, res) => {
    try {
        const {
            ...
            const defaultImage = 'https://cdn.dribbble.com/users/72790/screenshots/3333814/media/9c8536e9fec33b31959b9ce3843ab567.png'
        ...
        if (created) {
            for (let i=0; i<temperaments.length; i++) {
                const newDogTemperament = await Temperament.findByPk(temperaments[i].id);
